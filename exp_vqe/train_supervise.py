...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-path', default='../data_mitigate/mps/trainset_phasedamp.pkl', type=str)
    parser.add_argument('--test-path', default='../data_mitigate/mps/testset_phasedamp.pkl', type=str)
    ...
    args.logdir = os.path.join(args.logdir, f'env_mps_pd_{time_str}')
