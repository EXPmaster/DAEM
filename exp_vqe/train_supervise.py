...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-path', default='../data_mitigate/data_st11q_pd/trainset.pkl', type=str)
    parser.add_argument('--test-path', default='../data_mitigate/data_st11q_pd/valset.pkl', type=str)
    ...
    args.logdir = os.path.join(args.logdir, f'env_st11q_pd_{time_str}')
