...
def gen_large_data(data_root, save_path):
    ...
    for file_name in tqdm(os.listdir(data_root)):
        ...
        for p in noise_scales:
            ...
            obs_x = k0 @ sxx @ k0 + k1 @ sxx @ k1
            obs_y = k0 @ syy @ k0 + k1 @ syy @ k1
            obs_z = k0 @ szz @ k0 + k1 @ szz @ k1
...
if __name__ == '__main__':
    gen_large_data('../data_mitigate/mps/Random', '../data_mitigate/mps/trainset_ampdamp.pkl')
    gen_large_data('../data_mitigate/mps/Ising', '../data_mitigate/mps/testset_ampdamp.pkl')
