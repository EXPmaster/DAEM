...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-name', default='ibmq_random_mitigate2.pkl', type=str)
    parser.add_argument('--train-name', default='trainset_3.pkl', type=str)
    parser.add_argument('--test-name', default='testset_3.pkl', type=str)
