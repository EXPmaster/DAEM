...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-name', default='dataset.pkl', type=str)
    parser.add_argument('--train-name', default='trainset_vqe.pkl', type=str)
    parser.add_argument('--test-name', default='testset_vqe.pkl', type=str)
