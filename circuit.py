...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-name', default='swaptest.pkl', type=str)
    parser.add_argument('--train-name', default='trainset_swaptest.pkl', type=str)
    parser.add_argument('--test-name', default='testset_swaptest.pkl', type=str)
